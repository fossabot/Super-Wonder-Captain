...
gameFrame = Frame(window, height=800, width=1280)
backToMenuButton = Button(startFrame, text="MENU", width=15, command=switchToMenu)
backToMenuButton.config(font=("Quicksand", 10, "bold"), bg="#202020", fg="#fff", bd="0")
